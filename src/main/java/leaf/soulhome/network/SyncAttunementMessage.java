 ...
 */
public class SyncAttunementMessage implements SoulPayload
{
    public static final CustomPacketPayload.Type<SyncAttunementMessage> TYPE =
            new CustomPacketPayload.Type<>(ResourceLocationHelper.prefix("sync_attunement"));
