 ...
 */
public class AmbienceHoldMessage implements SoulPayload
{
    public static final CustomPacketPayload.Type<AmbienceHoldMessage> TYPE =
            new CustomPacketPayload.Type<>(ResourceLocationHelper.prefix("ambience_hold"));
