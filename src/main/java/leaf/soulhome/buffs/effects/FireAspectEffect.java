 ...
 *
 * <p>Still scoped to a direct hit. {@code LivingIncomingDamageEvent#getSource().getDirectEntity()} is the
 ...
 *
 * <p>{@code Entity#igniteForSeconds} already keeps the larger of the target's current burn
...
public class FireAspectEffect implements SoulBuffEffect
{
    ...
    public void onLivingHurt(LivingIncomingDamageEvent event)
    {
        ...
        event.getEntity().igniteForSeconds(seconds);
    }
}
