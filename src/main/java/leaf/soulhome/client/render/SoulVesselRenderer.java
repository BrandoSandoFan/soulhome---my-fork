...
public class SoulVesselRenderer extends LivingEntityRenderer<SoulVesselEntity, PlayerModel<SoulVesselEntity>>
{
    ...
    {
        return vessel.getOwnerId().map(this::skinFor).orElseGet(DefaultPlayerSkin::getDefaultTexture);
    }
    ...
    private ResourceLocation skinFor(UUID ownerId)
    {
        ...
        return info != null ? info.getSkin().texture() : DefaultPlayerSkin.get(ownerId).texture();
    }
}
