...
public class SoulBarrageShotEntity extends AbstractHurtingProjectile
{
    ...
    {
        super(EntityRegistry.SOUL_BARRAGE_SHOT.get(), caster, direction.normalize().scale(SPEED), level);
        ...
        this.lookAt(EntityAnchorArgument.Anchor.EYES, spawnPos.add(this.getDeltaMovement()));
    ...
    private void detonate()
    {
        ...
        level.playSound(null, this.blockPosition(), SoundEvents.GENERIC_EXPLODE.value(), SoundSource.PLAYERS, 0.6f, 1.5f);
