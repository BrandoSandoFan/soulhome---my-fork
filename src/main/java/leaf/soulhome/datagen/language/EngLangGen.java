...
public class EngLangGen extends LanguageProvider
{
    ...
    protected void addTranslations()
    {
        ...
        add("advancements.soulhome.gale_roost.description", "Raise a glass shaft in your soul taller than it is wide, with a bamboo mast at its heart and banners flying from the top.");
